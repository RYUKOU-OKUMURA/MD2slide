 ...
 *
 * Displays authentication state and provides login/logout actions.
...
export function LoginButton() {
  ...
  return (
    <button
      onClick={login}
      className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors shadow-sm"
    >
      {/* Google icon */}
